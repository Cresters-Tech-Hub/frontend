...
interface Props{
    handleChange:((event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => void) | undefined
}

const ReviewOrder = ({handleChange}:Props) => {
    ...
    return (
        <div className="review_order">
            ...
            <div className="discount_code">
                ...
                <CouponCode discount={discount} setDiscount={setDiscount} apply={apply} setApply={setApply}/>
            </div>
            <div className="order_summary">
                ...
                <div className="order_summary_content">
                    ...
                    <div className="order_items">
                        ...
                        <div className="right" style={{color: apply ? "#06c149" : ""}}>{discount < 1 ? "-" : "- "+discount}</div>
                    </div>
                    <span className="span" />
                    <div className="order_items">
                        <div className="left">Total</div>
                        <div className="right">
                            &#8358;{formatAmount(String(total > 800 ? total + 800 - discount : ""))}
                        </div>
                    </div>
                </div>
                <div className="btn">
                    ...
                    onClick={handleChange}
                        ...
                        style={{
                            fontSize: "16px",
                            background: total > 800 ? "#06c149" : "#eeeeee",
                            color: total > 800 ? "#fff" : "#424242"
                        }}
                        error={total < 800}
                    />
                </div>
